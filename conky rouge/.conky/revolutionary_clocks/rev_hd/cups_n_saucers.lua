...
--------------------	heure	-------------------
  {
    ...
    handle_length=100,              handle_circ=3,
    handle_fg_clr=0xFFFFFF,        handle_fg_alpha=1.0,
----------------------------
    graduation_radius=220,
    graduation_thickness=15,        graduation_mark_circ=1.5,
    graduation_mark_angle=30,
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.9,
---------------------------
    saucer_thickness=15,            thick_saucer_circ=11/12,    
    saucer_radius=300,             thin_saucer_circ=11/12,    
    saucer_fg_clr=0xFF0000,        saucer_fg_alpha=0.7,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true, 
...
-------------------	minutes	---------------------
    ...
    cup_bg_clr=0xffffff,           cup_bg_alpha=0.0,
    cup_fg_clr=0xFFFFFF,           cup_fg_alpha=0.0,
    handle_length=150,             handle_circ=2,
   handle_fg_clr=0xFFFFFF,        handle_fg_alpha=0.7,
----------------------
    graduation_radius=220,
    graduation_thickness=20,       graduation_mark_circ=2.0,
    graduation_mark_angle=90,
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.9,
------------------------
    saucer_thickness=15,            thick_saucer_circ=11/12,
    saucer_radius=275,             thin_saucer_circ=11/12,    
    saucer_fg_clr=0xFF0000,        saucer_fg_alpha=0.7,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true, 
    txt_weight=0,                  txt_size=8.0,
...
----------------------	secondes	-------------------
   {
    ...
    cup_radius=99,
    cup_wall_thickness=120,
    cup_bg_clr=0xff0000,           cup_bg_alpha=0.0,
    cup_fg_clr=0xFFFFFF,      	   cup_fg_alpha=0.0,
    handle_fg_clr=0xFFFFFF,        handle_fg_alpha=0.7,
    handle_length=198,              handle_circ=1,
---------------------
    graduation_radius=225,
    graduation_thickness=6,        graduation_mark_circ=0.2,
    graduation_mark_angle=6,
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.9,
---------------------
    saucer_thickness=15,		   thick_saucer_circ=11/12,
    saucer_radius=250,             thin_saucer_circ=11/12,    
    saucer_fg_clr=0xFF0000,        saucer_fg_alpha=0.7,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,  --  marqueur
   inner_saucer=true, 
    txt_weight=0,                  txt_size=8.0,
    txt_fg_clr=0xFFFFFF,           txt_fg_alpha=0.0,
    caption='',                    caption2='',
...
--------------------
    ...
    graduation_mark_angle=6,
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.4,
-----------------------
    saucer_thickness=10,            thick_saucer_circ=0.85,
    saucer_radius=70,              thin_saucer_circ=0.85,
    saucer_fg_clr=0xFF0000,	   saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
    },
...
--------------------
    ...
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.4,
-----------------------
    saucer_thickness=5,            thick_saucer_circ=0.85,
    saucer_radius=59,              thin_saucer_circ=0.85,
    saucer_fg_clr=0xFF0000,	   saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
    },
...
-----------------------
    saucer_thickness=5,            thick_saucer_circ=0.85,
    saucer_radius=49,              thin_saucer_circ=0.85,
    saucer_fg_clr=0xFF0000,	   saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
    },
-----------------------------------------
    {
...
-----------------------
    saucer_thickness=5,            thick_saucer_circ=0.85,
    saucer_radius=39,              thin_saucer_circ=0.85,
    saucer_fg_clr=0xFF0000,	   saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
    },
...

{
    ...
    saucer_thickness=10,		   thick_saucer_circ=0.85,
    saucer_radius=50,              thin_saucer_circ=0.85,    
    saucer_fg_clr=0xFF0000,        saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
},   
...
{
    name='downspeedf',		   arg='eth0',			max_value=1200,
    x=315,                         y=315,
    cup_radius=16,
    cup_wall_thickness=40,
    cup_start_angle=0,
    ...
    txt_weight=0,                  txt_size=14.0,
    txt_fg_clr=0xFFFFFF,           txt_fg_alpha=0.8,
    caption='',     	           caption2=' Kib',
--------------------
    graduation_radius=45,
    graduation_thickness=5,        graduation_mark_circ=2,
    graduation_mark_angle=25,
    graduation_fg_clr=0xFFFFFF,    graduation_fg_alpha=0.4,
-----------------------
    saucer_thickness=10,            thick_saucer_circ=0.85,
    saucer_radius=45,              thin_saucer_circ=5.85,
    saucer_fg_clr=0xFF0000,	   saucer_fg_alpha= 0.8,
    saucer_mark_fg_clr=0xFF0000,   saucer_mark_fg_alpha=0.9,
    inner_saucer=true,
    },
...
{
    name='upspeedf',		   arg='eth0',			max_value=400,
    x=435,                         y=315,
    cup_radius=16,
    cup_wall_thickness=40,
    cup_start_angle=0,
