...
#################
#
${color1}${goto 127}${voffset 10}${font caviar dreams:size=20}Cpu${goto 160}${voffset 40}${color0}${font caviar dreams:size=15}${cpu cpu0}%
...
#################
#
${color1}${goto 0}${voffset -65}${font caviar dreams:size=15}cpu1${goto 35}${voffset 25}${color0}${font caviar dreams:size=10}${cpu cpu1}%
...
#################
#
${color1}${goto 70}${voffset 55}${font caviar dreams:size=15}cpu2${goto 105}${voffset 25}${color0}${font caviar dreams:size=10}${cpu cpu2}%
#${color0}${goto 95}${voffset -25}${font caviar dreams:size=10}${hwmon 2 temp 3}°C
#
#############
#	cpu3	#
#############
${color1}${goto 197}${voffset -48}${font caviar dreams:size=15}cpu3${goto 235}${voffset 25}${color0}${font caviar dreams:size=10}${cpu cpu3}%
#${color0}${goto 185}${voffset -25}${font caviar dreams:size=10}${hwmon 2 temp 4}°C
#
#############
#	cpu4	#
#############
${color1}${goto 270}${voffset -152}${font caviar dreams:size=15}cpu4${goto 305}${voffset 25}${color0}${font caviar dreams:size=10}${cpu cpu4}%
...
#
#
${color1}${goto 120}${voffset 145}${font caviar dreams:size=20}Ram${goto 160}${voffset 35}${color0}${font caviar dreams:size=15}$memperc%
#
#
...
#################################
#
${color FFFFFF}${goto 0}${voffset 50}${font caviar dreams:size=15}Reseau 
# 
...
#
#
${color1}${goto 0}${voffset 60}${font caviar dreams:size=10}Ip de connection:${goto 115}${color0}${texeci 3600 wget http://checkip.dyndns.org -O - -o /dev/null | cut -d : -f 2 | cut -d \< -f 1}
#
#
